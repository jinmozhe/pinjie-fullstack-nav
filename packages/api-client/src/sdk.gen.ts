 ...
 * 查阅启用的全部导航分类
 *
 * 要求有效管理员查阅会话，包含仅登录可见分类。
 */
export const readerCategoriesApiV1NavReaderTaxonomyCategoriesGet = <ThrowOnError extends boolean = false>(options?: Options<ReaderCategoriesApiV1NavReaderTaxonomyCategoriesGetData, ThrowOnError>): RequestResult<ReaderCategoriesApiV1NavReaderTaxonomyCategoriesGetResponses, unknown, ThrowOnError> => (options?.client ?? client).get<ReaderCategoriesApiV1NavReaderTaxonomyCategoriesGetResponses, unknown, ThrowOnError>({
    responseType: 'json',
