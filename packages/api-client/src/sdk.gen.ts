 ...
 * 查阅全部已发布导航站点
 *
 * 要求有效管理员查阅会话，包含仅登录可见分类下的站点；仍排除停用分类、未发布及已删除站点。
 */
