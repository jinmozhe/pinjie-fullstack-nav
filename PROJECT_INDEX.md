...
| 当前阶段 | 导航管理、管理员 Web 查阅、分类可见与图标、站点永久删除、Web 响应式导航及后台网址信息抓取已完成本地源码与轻量验证；首版已由用户初始化，新增分类迁移、永久删除权限同步及完整业务、真实外站抓取与浏览器验收未执行 |
...
| 计划 | 状态 | 用途 |
| --- | --- | --- |
| [CNB 镜像发布核验计划](plans/2026-09-12_CNB镜像发布核验计划.md) | 实施中 | 核验 CNB 三端流水线和 TCR 镜像发布结果 |
