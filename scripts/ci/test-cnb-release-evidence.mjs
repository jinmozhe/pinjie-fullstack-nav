    ...
    `${JSON.stringify({
      ...
      config: {
        Labels: {
          ...
          "org.opencontainers.image.source": "https://github.com/jinmozhe/pinjie-fullstack-nav",
        },
      },
    })}\n`,
    "utf8",
...
const createEnvironment = {
  ...
  CNB_BUILD_WEB_URL: `https://cnb.cool/pjwl/pinjie-fullstack-nav/-/build/logs/${expectedBuildId}`,
};
...
try {
  ...
  await expectRejected("wrong build URL", (fixture) => {
    fixture.cnb.build_url = "https://cnb.cool/pjwl/pinjie-fullstack-nav/-/build/logs/123";
  });
