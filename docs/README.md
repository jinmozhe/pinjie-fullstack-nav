...
| [github-cnb-tcr-1panel-release-runbook.md](operations/github-cnb-tcr-1panel-release-runbook.md) | CNB Token、GitHub Secret 与本机 TCR 访问配置，以及 GitHub Actions 经 CNB、TCR 到 1Panel 的发布、验证和回滚手册 |
